...
export default function RepoCard(props: { repo: GitHubAPIRepo }) {
  ...
  return (
    <div
      className="border-slate-500 hover:border-compositr delay-75 duration-300 transition-all border not-prose rounded h-full cursor-pointer hover:scale-105 even:hover:-rotate-1 odd:hover:rotate-1 flex flex-col p-3 w-full"
